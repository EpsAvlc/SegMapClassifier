...
# current dir
folder = "/home/cm/Projects/SegmapClassifier/"
...
class Dataset(object):
    ...
    # ..tools.import_export import load_segments, load_positions, load_features
        ...
        # self.classes 所有从文件中读取的segment id 
    ...
    #  去除Segments中，相同id尺寸较小的segment，保留尺寸较大的segment。
